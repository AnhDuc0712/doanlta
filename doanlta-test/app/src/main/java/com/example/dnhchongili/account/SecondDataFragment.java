...
public class SecondDataFragment extends Fragment {
    ...
    private void initViews(View view) {
        ...
        userApi = new UserApi(SocketManager.getSocket());
    ...
    // FIXED: Không truy cập Room DB trên main thread
        ...
        executor.execute(() -> {
            ...
            try (InputStream inputStream = requireContext().getContentResolver().openInputStream(uri);
                ...
                Request request = new Request.Builder()
                        .url("http://10.0.2.2:5000/api/user/upload-avatar")
    ...
    public void onDestroy() {
        super.onDestroy();
        // Không cần disconnectSocket nếu dùng SocketManager cho toàn app.
    }
}
